    ...
    <SafeAreaView className="flex-1 bg-cream" edges={['top']}>
      ...
      >
        ...
        <View className="bg-cream px-6 py-4 pb-[110px]">
          <View className="flex-row items-center bg-white border border-[#D9D9D9] rounded-[16px] pl-4 pr-2 py-2 min-h-[56px] max-h-[120px]">
            <TextInput 
              placeholder="Tulis apa yang kamu rasakan..."
              className="flex-1 font-jakarta-regular text-[14px] text-black outline-none min-h-[40px] pt-1 pb-1"
            ...
            />
            <TouchableOpacity 
              className={`w-[44px] h-[44px] rounded-[14px] items-center justify-center ml-2 flex-shrink-0 ${
                inputText.trim() && !isStreaming ? "bg-[#357BF7]" : "bg-[#A0C4FF]"
              }`}
              onPress={handleSend}
