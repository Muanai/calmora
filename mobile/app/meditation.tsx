...
const IconRileks = ({ color, width = 32, height = 28 }: { color?: string; width?: number; height?: number }) => (
...
const IconLelap = ({ color, width = 27, height = 27 }: { color?: string; width?: number; height?: number }) => (
  <Svg width={width} height={height} viewBox="0 0 27 27" fill="none">
...
const IconAlam = ({ color, width = 24, height = 30 }: { color?: string; width?: number; height?: number }) => (
...
const IconFokus = ({ color, width = 31, height = 31 }: { color?: string; width?: number; height?: number }) => (
